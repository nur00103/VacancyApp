...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        try {
            if (request.getServletPath().startsWith("/user/confirmPassword")||request.getServletPath().startsWith("/user/forgotPassword")||request.getServletPath().startsWith("/auth/login")|| request.getServletPath().startsWith("/user/confirmation") || request.getServletPath().startsWith("/user/save") || request.getServletPath().startsWith("/file/upload")) {
